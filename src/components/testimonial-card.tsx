...
export function TestimonialCard({
  ...
  return (
    <figure className="flex h-full flex-col rounded-2xl border border-border-soft bg-card p-6 dark:border-white/10">
      ...
      <figcaption className="mt-5 flex items-center gap-3 border-t border-border-soft pt-4 dark:border-white/10">
        <span
